...
# docker build ./ -t rz-ent-kb-bot-guidance:0.2
# docker run -it --name rz-ent-kb-bot-guidance -p80:80 rz-ent-kb-bot-guidance:0.2

# "login to Azure Container Registry"
# docker login -u <user> -p <password> acr0612.azurecr.cn
# "create a new tag for a Docker image with repository name"
# docker tag rz-ent-kb-bot-guidance:0.2 acr0612.azurecr.cn/rz-ent-kb-bot-guidance:0.2
# "push a Docker image to a container registry"
# docker push acr0612.azurecr.cn/rz-ent-kb-bot-guidance:0.2
